...
import shoping_by_kmp.shared.generated.resources.map
import shoping_by_kmp.shared.generated.resources.map_border
...
sealed class BottomNavigation(
    ...
    data object Map : BottomNavigation(
        route = "Map",
        title = "Stores",
        selectedIcon = Res.drawable.map,
        unSelectedIcon = Res.drawable.map_border
    )
}
